 ...
 * @since version 1.0
 */
public class IntCircularDoublyLinkedListTest {
    @Test
    public void test() {
        IntCircularDoublyLinkedList list = new IntCircularDoublyLinkedList();
        // for empty list
        assertThat(list.size()).isEqualTo(0);
        assertThat(list.isEmpty()).isTrue();
        assertThat(list.getFirstNode()).isNull();
        try {
            list.get(0);
        ...
        list.reverse();
        assertThat(list).isEqualTo(new IntCircularDoublyLinkedList());
        list.addTail(0);
        list.clear();
        assertThat(list.getFirstNode()).isNull();
        ...
        assertThat(list.size()).isEqualTo(1);
        assertThat(list.get(0)).isEqualTo(0);
        IntCircularDoublyLinkedList.Node node = list.getNode(0);
        assertThat(node.getValue()).isEqualTo(0);
        assertThat(node.getNext()).isSameAs(node);
        assertThat(node.getPrevious()).isSameAs(node);
        list.clear();
        ...
        IntList reversed = list.reversed();
        assertThat(reversed).isNotSameAs(list);
        assertThat(reversed.toArray()).isEqualTo(new int[]{0, 2, 1, 4, 0});
        list.clear();
        assertThat(list.isEmpty());
    }
}
